...
cd /home/pwdemo.stefan/pw/jobs/fast-loon/logs/setup-and-launch/step_6
echo $$ > step.pid
...
do
  ...
  cat << EOF > sl.Dec-2021b-log10-gss.${ii}.sbatch
#!/bin/bash
#SBATCH --exclusive
#SBATCH --job-name=Dec-2021b-log10-gss.${ii}
#SBATCH --output=sl.std.out.Dec-2021b-log10-gss.${ii}
...
EOF
  ...
  sbatch sl.Dec-2021b-log10-gss.${ii}.sbatch
done
echo "===================================="
